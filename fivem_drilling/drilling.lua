...
Drilling.DisabledControls = {30,31,32,33,34,35,24,257,25,263}
...
Drilling.LowHeat = function()
  Citizen.CreateThread(function()
    while Drilling.Active do
      Citizen.Wait(1000)
      if Drilling.DrillTemp > 0.0 then
        Drilling.DrillTemp = Drilling.DrillTemp-0.05
