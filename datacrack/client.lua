...
function F_02668(arg1)
    Citizen.CreateThread(function()
        ...
        while true do
            F_02539()
            F_02536("Kliknij ~INPUT_FRONTEND_CANCEL~, aby anulowac")
    ...
    Citizen.CreateThread(function()
        ...
        PushScaleformMovieFunctionParameterString("Moj komputer")
        PopScaleformMovieFunctionVoid()

        PushScaleformMovieFunction(scaleform, "ADD_PROGRAM")
        PushScaleformMovieFunctionParameterFloat(6.0)
        PushScaleformMovieFunctionParameterFloat(6.0)
        PushScaleformMovieFunctionParameterString("Wylacz")
        PopScaleformMovieFunctionVoid()
